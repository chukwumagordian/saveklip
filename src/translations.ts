...
export const translations: Record<LanguageCode, TranslationDictionary> = {
  ...
  es: {
    ...
    copyrightText: "© 2026 SaveKlip Systems. Realizado en conformidad con los protocolos web de alto rendimiento.",
  ...
  fr: {
    ...
    copyrightText: "© 2026 SaveKlip Systems. Réalisé conformément aux protocoles web de haute performance.",
  ...
  de: {
    ...
    copyrightText: "© 2026 SaveKlip Systems. Realisiert in Übereinstimmung mit Hochleistungs-Webprotokollen.",
  ...
  pt: {
    ...
    copyrightText: "© 2026 SaveKlip Systems. Realizado em conformidade com protocolos web de alto desempenho.",
