...
export const translations: Record<LanguageCode, TranslationDictionary> = {
  en: {
    ...
    heroTitleHome: "Save High-Quality TikTok, Instagram & X Videos",
    heroTitleTikTok: "Save High-Quality TikTok Videos",
    heroTitleInstagram: "Save High-Quality Instagram Videos",
    heroDescHome: "Easily download your favorite TikTok videos, Instagram reels, and X (Twitter) clips in high quality. No sign-ups, no watermarks, and completely free.",
    ...
    placeholderHome: "TikTok, Instagram, or X (Twitter) URL link...",
    ...
    validationErrorEmpty: "Please enter a valid TikTok, Instagram or X URL first",
    validationErrorInvalid: "Please enter a valid TikTok, Instagram or X video link",
